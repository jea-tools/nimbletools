...
#[tauri::command]
pub fn calculate_file_hash(file_path: String) -> HashResult {
    ...
    HashResult {
        ...
        sha256,
        sha512,
        message: "Hash calculated".into(),
    }
}

#[tauri::command]
pub fn calculate_text_hash(text: String) -> HashResult {
...
fn sha512_hash(data: &[u8]) -> String {
    ...
    for chunk in msg.chunks(128) {
        let mut w = [0u64; 80];
        for (i, c) in chunk.chunks(8).enumerate().take(16) {
